...
<form action="${contextPath}/admin/login.action" method="post" id="adminLoginForm">
    <div class="content">
        <div class="right_div">
            ...
            <input type="text" id="inputAdminLoginName" name="adminLoginName" placeholder="管理员登录名" /><br />
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="${contextPath}/admin/resetPass.action" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="adminLoginName" placeholder="管理员登录名" name="adminLoginName">
                        </div>
                    </div>
                    <div class="form-group">
