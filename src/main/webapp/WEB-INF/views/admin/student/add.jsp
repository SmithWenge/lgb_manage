...
<div class="row" style="margin-left: 2%; margin-right: 2%; margin-top: 5px;">
    ...
    <form style="margin-left: 2%; margin-right: 2%; margin-top: 1%;" id="stuAddForm">
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                <label for="stuName" class="col-md-3 control-label">姓名</label>
                <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-4 form-group">
                    <label for="stuType" class="col-md-3 control-label">人员类型</label>
                    <div class="col-md-9">
                        <tags:dicselect name="stuType" key="stuType" value="3" id="stuType" />
                    </div>
                </div>
                <div class="col-md-4 form-group">
                    <label for="stuNationality" class="col-md-3 control-label">民族</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="stuNationality" name="stuNationality" placeholder="汉族">
                    </div>
                </div>
                <div class="col-md-4 form-group">
                    <label for="stuLevel" class="col-md-3 control-label">级别</label>
                    <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-4 form-group">
                    <label for="stuIdentifiedType" class="col-md-3 control-label">证件</label>
                    <div class="col-md-9">
                ...
                <div class="col-md-4 form-group">
                    <label for="stuSpeciality" class="col-md-3 control-label">特长</label>
                    <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    <label for="stuLastEightNum" class="col-md-3 control-label">身份证后八位</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="stuLastEightNum" name="stuLastEightNum">
                    </div>
                </div>
                <div class="col-md-4 form-group">
                    <label for="stuPreferential" class="col-md-3 control-label">优惠</label>
                    <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    <label for="stuDependentsTel" class="col-md-3 control-label">家属电话</label>
                    <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-4 form-group">
                    <label for="stuOldWorkPlaceName" class="col-md-3 control-label">原工作单位</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="stuOldWorkPlaceName" name="stuOldWorkPlaceName">
                    </div>
                </div>
                <div class="col-md-4 form-group">
                    <label for="stuHealth" class="col-md-3 control-label">身体状况</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="stuHealth" name="stuHealth">
                    </div>
                </div>
                <div class="col-md-4 form-group">
                    <label for="stuDependentsDesc" class="col-md-3 control-label">家属关系</label>
                    <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    <label for="stuLocation" class="col-md-3 control-label">现住址</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="stuLocation" name="stuLocation">
                    </div>
                </div>
                <div class="col-md-4 form-group">
                    <label for="stuRemarkOne" class="col-md-3 control-label">备注</label>
                    <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-4 form-group">
                    <label for="stuOldWorkType" class="col-md-3 control-label">原职务（或职业）</label>
                    <div class="col-md-9">
                ...
                <div class="col-md-4 form-group">
                    <label for="stuRemarkTwo" class="col-md-3 control-label">备注2</label>
                    <div class="col-md-9">
